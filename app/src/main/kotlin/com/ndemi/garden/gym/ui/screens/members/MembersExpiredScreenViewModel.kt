...
import com.ndemi.garden.gym.ui.screens.members.MembersExpiredScreenViewModel.Action
...
class MembersExpiredScreenViewModel (
    ...
    fun getMembers() {
        ...
        viewModelScope.launch {
            memberUseCase.getExpiredMembers().also { result ->
                when(result){
